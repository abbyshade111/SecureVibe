...
- **Read the script inside a page.** **[taken: keen-meninsky-691a27, 24 September 2026]** A page with a
  script written into it is still unread, which is correct and still silences every rule for the app.
