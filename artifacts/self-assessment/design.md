...
Generated by SecureVibe on 2026-09-20 from the design profile (hash `69d7e7b1e51d`), following the OWASP Secure by Design Framework v0.5. This document is derived by rules from the answers given in the wizard; it is not a certification.
...
| F-02 | app → db | SQLite file | passwords, confidential business information | no | TPL-DB-01, TPL-DB-02, TPL-DB-04, TPL-DTO-01 | Reads and writes records with parameterised queries only. |
...
| Id | Title | Date | File |
| --- | --- | --- | --- |
| ADR-001 | Authentication model: local accounts with passwords | 2026-09-20 | adr/ADR-001-authentication-model.md |
| ADR-002 | Session store: server-side sessions in SQLite | 2026-09-20 | adr/ADR-002-session-store.md |
| ADR-003 | Data encryption: file permissions and disk encryption; no field encryption | 2026-09-20 | adr/ADR-003-data-encryption-and-keys.md |
| ADR-004 | File uploads: not included | 2026-09-20 | adr/ADR-004-file-uploads.md |
| ADR-005 | AI boundary: the assistant advises, application code decides | 2026-09-20 | adr/ADR-005-ai-boundary.md |
| ADR-006 | Deployment and exposure: this computer only (loopback) | 2026-09-20 | adr/ADR-006-deployment-and-exposure.md |
| ADR-007 | Logging, audit and data retention | 2026-09-20 | adr/ADR-007-logging-and-retention.md |
| ADR-008 | Dependency policy: locked, script-free, inventoried | 2026-09-20 | adr/ADR-008-dependency-policy.md |
