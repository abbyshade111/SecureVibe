// Clean fixture stand-in for the real route registry. The handler is typed loosely (not `unknown`) so
// that call-site arrow functions get contextual `req`/`res` types instead of failing `noImplicitAny`.
