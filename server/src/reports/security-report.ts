...
function reVerifyCommands(input: ReportModel): { label: string; command: string }[] {
  return [
...
export function renderSecurityReport(input: ReportModel): { md: string; html: string; json: string } {
