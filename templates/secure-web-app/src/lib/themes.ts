 ...
 *
 * A theme is colour and nothing else: each name matches a set of colour values in `public/css/app.css`, which the
...
export const THEME_DESCRIPTIONS: Record<Theme, string> = {
  calm: 'Calm — quiet greys and a blue for links and buttons. The default.',
